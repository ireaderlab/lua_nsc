-- copy from kong
-- zynsc_lua helper methods to send HTTP responses to clients.
...
-- @module zynsc_lua.tools.responses
-- @usage
--    local responses = require "zynsc_lua.tools.responses"
--
...
local meta = require "zynsc_lua.meta"

--local server_header = _zynsc_lua._NAME.."/".._zynsc_lua._VERSION
